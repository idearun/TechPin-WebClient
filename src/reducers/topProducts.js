  ...
  switch (action.type) {
    ...
    case actionTypes.SUCCESSFUL_NEW_RATE_SUBMIT:
      ...
      const indexInBetween1And10Million =
        ...
        state.between1And10Million.findIndex(product => product.slug === action.slug)
      ...
      if (Object.keys(state).length > 0) {
        ...
        if (indexInPlus10Million && indexInPlus10Million !== -1) {
          startupToMutateInPlus10Million = state.plus10Million[indexInPlus10Million]
        ...
        if (indexInBetween1And10Million && indexInBetween1And10Million !== -1) {
          ...
          startupToMutateInBetween1And10Million.rate_count = action.newRateCount
          startupToMutateInBetween1And10Million.average_p_rate = action.newRating
          newBetween1And10Million = [
