...
export var baseApiUrl = 'https://api.techpin.org'
...
export default class techPinApi {
  ...
  static getUserProfile(token) {
    ...
    return axios.get(`${baseApiUrl}/profile/`, { headers })
  }

  static updateUserProfile(token) {
    const headers = {
      'Content-Type': 'application/x-www-form-urlencoded',
      Authorization: 'Token ' + token,
      Accept: '*/*',
    ...
    return axios.patch(`${baseApiUrl}/profile/`, { headers })
  }
}
